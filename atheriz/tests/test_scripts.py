...
class DummyAfterScript(Script):
    @after
    def at_test_hook(self, arg1, kwarg1=None, result=None):
        self.child.log.append(f"after: {arg1}, {kwarg1}, {result}")
        return "after_result"
...
def test_after_hook():
    ...
    assert obj.log == ["at_test_hook: v3, v4", "after: v3, v4, original_result"]
