...
Default value: `'{name}: {desc}{things}'`

#### `@classmethod def create(cls, caller: Object | None, name: str, desc: str = '', aliases: list[str] | None = None, is_pc: bool = False, is_item: bool = False, is_npc: bool = False, is_mapable: bool = False, is_container: bool = False, is_tickable: bool = False, tick_seconds: float = settings.DEFAULT_TICK_SECONDS)`
...
#### `def has_script_type(self, script_type: str)`
...
#### `def get_scripts_by_type(self, script_type: str)`
...
#### `def delete(self, caller: Object, recursive: bool = True)`
...
#### `def at_delete(self, caller: Object)`
...
#### `def at_legend_update(self, legend: list[tuple[str, str, tuple[int, int]]], show_legend: bool = True, area: str = 'Somewhere')`
...
#### `def at_map_update(self, map: str, legend: list[tuple[str, str, tuple[int, int]]], min_x: int, max_y: int, show_legend: bool = True, area: str = 'Somewhere')`

#### `def at_pre_map_render(self, grid: dict[tuple[int, int], str])`
...
#### `def msg_contents(self, text: str | None = None, exclude: list | None = None, from_obj = None, mapping: dict | None = None, raise_funcparse_errors: bool = False, msg_type: str | None = None, **kwargs)`
...
#### `def at_pre_move(self, destination: Node | Object | None, to_exit: str | None = None, **kwargs)`
...
#### `def at_post_move(self, destination: Node | Object | None, to_exit: str | None = None, **kwargs)`
...
#### `def move_to(self, destination: Node | Object | None, to_exit: str | None = None, force = False, announce = True, **kwargs)`
...
#### `def at_puppet(self, caller: 'Object')`
...
#### `def at_unpuppet(self, caller: 'Object')`
...
#### `def at_msg_receive(self, text: str | None = None, from_obj: Object | None = None, msg_type: str | None = None, **kwargs)`
...
#### `def at_msg_send(self, text: str | None = None, to_obj: Object | None = None, msg_type: str | None = None, **kwargs)`
...
#### `def at_pre_put(self, putter: Object, destination: Object, **kwargs)`
...
#### `def at_put(self, putter: Object, destination: Object, **kwargs)`
...
#### `def at_pre_hear(self, emitter: Object, sound_desc: str, sound_msg: str, loudness: float, is_say: bool)`
...
#### `def at_say(self, message: str, msg_self = None, msg_location = None, receivers = None, msg_receivers = None, msg_type: str | None = None, **kwargs)`
...
#### `def format_appearance(self, appearance: str, looker: Object, **kwargs)`
...
#### `def at_pre_object_leave(self, destination: Node | Object | None, to_exit: str | None = None, **kwargs)`
...
#### `def at_object_leave(self, destination: Node | Object | None, to_exit: str | None = None, **kwargs)`
...
#### `def at_pre_object_receive(self, source: Node | Object | None, from_exit: str | None = None, **kwargs)`
...
#### `def at_object_receive(self, source: Node | Object | None, from_exit: str | None = None, **kwargs)`
...
#### `def delete(self, caller: Object, recursive: bool = False)`
...
#### `def has_link_name(self, name: str)`
...
#### `def get_display_characters(self, looker: Object | None = None, **kwargs)`
...
#### `def get_display_exits(self, looker: Object | None = None, **kwargs)`
...
#### `def get_display_doors(self, looker: Object | None = None, **kwargs)`
...
#### `def filter_contents(self, l: Callable[[Any], bool])`
...
#### `def get_nodes(self, coords: list[tuple[int, int, int]])`

optimized for getting nodes from list of coords

#### `def get_nodes_in_sphere(self, center: tuple[int, int, int], radius: float, ignore_center: bool = False)`

#### `def get_rays_in_sphere(self, center: tuple[int, int, int], radius: float, ignore_center: bool = True)`

#### `def get_neighbors(self, coord: tuple[int, int, int])`
...
#### `@classmethod def create(cls, name: str, password: str)`

Create a new account.

#### `def delete(self, caller: Object | None = None, unused: bool = True)`
...
#### `def at_pre_puppet(self, character: Object)`
...
#### `def remove_character(self, character: Object)`
...
#### `@staticmethod def hash_password(password: str)`
...
### Class: `BaseChannelCommand`

#### `key`

Default value: `'__base_channel'`

#### `desc`

Default value: `'Command for accessing channel'`

#### `category`

Default value: `'Communication'`

#### `@property def channel(self)`

Channel: The channel object this command communicates through.

#### `@channel.setter def channel(self, channel: Channel)`
...
#### `@classmethod def create(cls, name: str, caller: Object | None = None)`
...
#### `def msg(self, message: str, sender: Object | None = None)`

Send a message to the channel.

#### `def format_message(self, timestamp: int, sender: str, message: str)`

Format a message. Override in subclasses for custom formatting.

#### `def get_history(self, count: int = settings.CHANNEL_HISTORY_LIMIT)`
...
#### `def install_hooks(self, child: Object | Node)`
...
#### `def remove_hooks(self, child: Object | Node | None = None)`
...
#### `def access(self, caller: Object | Connection)`
...
#### `def execute(self, caller: Object | Connection, args_string: str, cmdstring: str = '')`
...
### `def get_by_tag(tag: str | list[str] | set[str], all: bool = False)`
...
#### `@staticmethod def render_grid(grid: dict[tuple[int, int], str])`

renders the grid into a string
Returns: tuple of (rendered_string, min_x, max_y)

#### `@staticmethod def get_dirs(grid: dict[tuple[int, int], str], coord: tuple[int, int], chars: list[str])`

returns a tuple of booleans representing the directions of the walls around a coordinate

#### `@staticmethod def _resolve_char(n: bool, s: bool, e: bool, w: bool, style: str)`
...
#### `def move_listener(self, listener: Object, to_coord: Coord, from_coord: Coord | None = None)`

#### `def move_mapable(self, mapable: Object, to_coord: Coord, from_coord: Coord | None = None)`
...
#### `def remove_alarm(self, hour: str, minute: str, caller: int | Object)`
...
#### `def sun_up_alt(self, hour: int)`

#### `def on_tick(self)`

#### `def get_timespan(self, ticks: int)`
...
### `def wrap_truecolor(input: str, fg = None, bg = 0.0, fg_bright = 100.0, fg_sat = 100.0, bg_bright = 100.0, bg_sat = 100.0, bold = False, italic = False, underline = False, inverse = False, strikethru = False, clear = False)`
...
### `def strip_ansi(input: str)`

### `def strip_terminal_escapes(input: str)`
...
### `def get_dir(origin: tuple, dest: tuple)`

get map direction between two coords.
returns '' if origin == dest

### `def dist_3d(origin: tuple, dest: tuple)`

### `def get_reverse_link(location: Node, destination: Node)`
...
### `def get_points_in_sphere(center: tuple[int, int, int], radius: float, ignore_center: bool = False)`

### `def compress_whitespace(text: str, max_linebreaks: int = 1, max_spacing: int = 2)`
...
### `def funcparser_callable_you_capitalize(*args, you = None, receiver = None, mapping = None, capitalize = True, **kwargs)`

Usage: $You() - capitalizes the 'you' output.

### `def funcparser_callable_your(*args, caller = None, receiver = None, mapping = None, capitalize = False, **kwargs)`
...
### `def funcparser_callable_your_capitalize(*args, you = None, receiver = None, mapping = None, capitalize = True, **kwargs)`
...
### `def funcparser_callable_pronoun_capitalize(*args, caller = None, receiver = None, capitalize = True, **kwargs)`
